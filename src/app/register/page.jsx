    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-slate-900/50 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-3xl font-heading font-bold text-center mb-2">Create an account</h2>
          <p className="text-slate-400 text-center mb-6 text-sm">Join BlogSphere and start writing</p>
